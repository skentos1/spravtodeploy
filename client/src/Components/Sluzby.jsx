...
const profiles = [
  {
    ...
    name: 'Marek',
    job: 'Kosenie trávy',
    description: 'Ahoj, moje meno je Marek a som študent vysokej školy. Rád by som si privyrobil pomocnými prácami, ako je kosenie a záhradné práce.',
    cena: '10€',
  },
  {
    img: marek,
    name: 'Jakub',
    job: 'Stavebné práce',
    description: 'Volám sa Jakub, študujem na strednej odbornej škole. Ručné práce mi vôbec nie sú cudzie a rád by som vám vypomohol.',
    cena: '15€',
  },
  {
    img: petra,
    name: 'Katka',
    job: 'Stráženie detí',
    description: 'Ahojte, som Katka, mám 19 rokov. Vo voľnom čase sa venujem animátorstvu a rada trávim čas s deťmi, preto vám ich rada postrážim.',
    cena: '6€',
  },
];
...
const Services = () => {
  ...
  return (
    <div className="flex justify-center w-full bg-white py-12">
      <div className="max-w-5xl w-full flex flex-col lg:flex-row min-h-screen pt-12 px-4">
        <div className="lg:w-1/2 w-full text-center lg:text-left mb-8 lg:mb-0 border-t pt-4">
          ...
          <div className="flex justify-center items-center mt-24">
            <button onClick={handleButtonClick} className="bg-black text-white font-bold py-2 px-4 rounded hover:bg-gray-800">
              Prihlás sa na Prácu
            </button>
          </div>
          <p
            ...
            onClick={handleClick}
          >
            Informuj sa o prihlasovaní na práce tu.
          </p>
        </div>
          ...
          {profiles.map((profile, index) => {
            ...
            return (
              <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="flex items-center cursor-pointer p-4 hover:bg-gray-200" onClick={() => toggleExpand(index)}>
                  <img className="w-10 h-10 object-cover rounded-full ml-4" src={profile.img} alt={profile.name} />
